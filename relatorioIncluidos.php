...
<body>
    ...
    if (isset($_POST['gerar_relatorio'])) {
        ...
        if ($totalResultados > 0) {
            ...
            echo '<a href="exportarIncluidos.php?tabela=' . urlencode($tabela) . '&data_inicio=' . urlencode($data_inicio) . '&data_fim=' . urlencode($data_fim) . '" class="submit-btn">Exportar para Excel</a>';
            echo '</div>';
        }
