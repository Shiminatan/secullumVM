    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #999da1;">
        ...
        <div id="myModal" class="modal">
            <div class="modal-content">
                ...
                <div class="option"><a href="relatorioIncluidos.php" target="_blank">INCLUIDOS</a></div>
                <div class="option"><a href="relatorioCancelados.php" target="_blank">CANCELADOS</a></div>
            </div>
        </div>
        ...
        <div class="d-flex align-items-center">
            ...
            if (isset($currentUser) && $currentUser['funcao'] == 'admin') {
                echo '<a href="cadastroMassaComunicador.php" class="btn btn-primary me-3">CADASTRAR</a>';
            }
            ?>
