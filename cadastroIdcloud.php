<?php
   ...
   $result = mysqli_query($conexao, "INSERT INTO idcloud (revenda, cliente, cnpj, estado, banco, rep, nserial, portaria,sistema, login_, senha, ticket_incl, ticket_canc, case_, data_incl, data_canc, obs) 
   VALUES('$revenda', '$cliente','$cnpj','$estado', '$banco', '$rep', '$nserial', '$portaria','$sistema', '$login_', '$senha', '$ticket_incl','$ticket_canc', '$case_','$data_incl', '$data_canc', '$obs')");
