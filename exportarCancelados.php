...
if (isset($_GET['tabela']) && isset($_GET['data_inicio']) && isset($_GET['data_fim'])) {
    ...
    $sql = "SELECT revenda, cliente, cnpj, banco, estado, data_canc FROM $tabela WHERE data_canc BETWEEN ? AND ? ORDER BY revenda ASC";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<td>' . htmlspecialchars($row['data_canc']) . '</td>';
        echo '</tr>';
    }
