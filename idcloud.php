...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #999da1;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <?php
            // Verifica se o usuário está logado e se possui a função de administrador para visualizar o botão
            if (isset($currentUser) && $currentUser['funcao'] == 'admin') {
                echo '<div>';
                echo '<a href="cadastroIdcloud.php" class="btn btn-success">CADASTRAR</a>';
                echo '</div>';
            }
            ?>
            <div class="d-flex">
